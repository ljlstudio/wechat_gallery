 ...
 * desc   :
 */
public class CommonBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private static final String TAG = "CommonBottomSheetBehavior";
    ...
    public CommonBottomSheetBehavior() {
    }

    public CommonBottomSheetBehavior(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
     ...
     * @attr ref
     * com.google.android.material.R.styleable#CommonBottomSheetBehavior_Layout_behavior_peekHeight
     */
     ...
     * @attr ref
     * com.google.android.material.R.styleable#CommonBottomSheetBehavior_Layout_behavior_halfExpandedRatio
     */
     ...
     * @attr ref
     * com.google.android.material.R.styleable#CommonBottomSheetBehavior_Layout_behavior_expandedOffset
     */
     ...
     * @attr ref com.google.android.material.R.styleable#CommonBottomSheetBehavior_Layout_behavior_hideable
     */
     ...
     * @attr ref
     * com.google.android.material.R.styleable#CommonBottomSheetBehavior_Layout_behavior_skipCollapsed
     */
     ...
     * @attr ref com.google.android.material.R.styleable#CommonBottomSheetBehavior_Layout_behavior_draggable
     */
     ...
     * @attr ref com.google.android.material.R.styleable#CommonBottomSheetBehavior_Layout_behavior_saveFlags
     * @see #getSaveFlags()
     */
    ...
    public void setBottomSheetCallback(BottomSheetCallback callback) {
        Log.w(
                TAG,
                "CommonBottomSheetBehavior now supports multiple callbacks. `setBottomSheetCallback()` removes"
    ...
    private void setSystemGestureInsets(@NonNull View child) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && !isGestureInsetBottomIgnored() && !peekHeightAuto) {
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, @NonNull CommonBottomSheetBehavior<?> behavior) {
            super(superState);
        ...
        /**
         * This constructor does not respect flags: {@link CommonBottomSheetBehavior#SAVE_PEEK_HEIGHT}, {@link
         * CommonBottomSheetBehavior#SAVE_FIT_TO_CONTENTS}, {@link CommonBottomSheetBehavior#SAVE_HIDEABLE}, {@link
         * CommonBottomSheetBehavior#SAVE_SKIP_COLLAPSED}. It is as if {@link CommonBottomSheetBehavior#SAVE_NONE}
         * were set.
         *
         * @deprecated Use {@link #SavedState(Parcelable, CommonBottomSheetBehavior)} instead.
         */
        @Deprecated
    ...
    /**
     * A utility function to get the {@link CommonBottomSheetBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link CommonBottomSheetBehavior}.
     * @return The {@link CommonBottomSheetBehavior} associated with the {@code view}.
     */
    @NonNull
    @SuppressWarnings("unchecked")
    public static <V extends View> CommonBottomSheetBehavior<V> from(@NonNull V view) {
        ...
        if (!(behavior instanceof CommonBottomSheetBehavior)) {
            throw new IllegalArgumentException("The view is not associated with CommonBottomSheetBehavior");
        }
        return (CommonBottomSheetBehavior<V>) behavior;
    }
